...
results = pd.read_csv("results/results_static_test_cs_1.csv")
...
# ax2.legend([" Benefits"])
plt.title("Static case, client with 30K€ and high credit score")

# Save the figure in a png
plt.savefig("test_results_static_high_credit_score.png", dpi = 1000)
