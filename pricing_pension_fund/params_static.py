...
h2_probs = np.array([0.05, 0.1, 0.2, 0.2, 0.1, 0.1, 0.1, 0.05, 0.05, 0.05])
...
h2_values_multiple = np.array([0.025, 0.03, 0.035, 0.04, 0.045, 0.05, 0.055, 0.06, 0.065])
h2_probs_multiple = np.array([0.05, 0.1, 0.2, 0.2, 0.15, 0.1, 0.1, 0.05, 0.05])
...
simulation_params = {'x' : x, 'rho_client_low' : rho_client_low, 'rho_client_high' : rho_client_high, 
    ...
    'h2_values_multiple' : h2_values_multiple, 'h2_probs_multiple' : h2_probs_multiple}
